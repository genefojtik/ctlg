...
import com.atomicaxis.ctlg_app.web.NoteController;
...
privileged aspect NoteController_Roo_Controller {
    ...
    void NoteController.addDateTimeFormatPatterns(Model uiModel) {
        uiModel.addAttribute("note_createdatetime_date_format", DateTimeFormat.patternForStyle("M-", LocaleContextHolder.getLocale()));
    }
